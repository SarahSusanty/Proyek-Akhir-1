            ...
            <div class="sideBox">
                ...
                <ul>
                    ...
                    <div class="dropDownItem" id="aspirasi">
                        <ul>
                            <li><a href="/pengunjung/aspirasi">Semua aspirasi</a></li>
                            <li><a href="/pengunjung/aspirasi/baru">Buat aspirasi baru</a></li>
                        </ul>
                    </div>
                    <li>
                    ...
                    <div class="dropDownItem" id="forum">
                        <ul>
                            <li><a href="/pengunjung/forum">Forum saya</a></li>
                            <li><a href="/pengunjung/forum/ditolak">Forum ditolak</a></li>
                            <li><a href="/pengunjung/forum/menunggu">Forum menunggu</a></li>
                            <li><a href="/pengunjung/forum/join">Masuk ke dalam forum</a></li>
                        </ul>
                    </div>
                    <li>
                    ...
                    <div class="dropDownItem" id="data-diri">
                        <ul>
                            <li><a href="/pengunjung/datadiri">Biodata</a></li>
