...
@section('content')
    <div class="header-right shadow-sm">
        ...
        <p><a href="/pengunjung/aspirasi">Aspirasi</a> / Tambah Aspirasi </p>
    </div>
    <div class="content-right">
        <div class="bigContent">
            <h5>Tambahkan Aspirasi</h5>
            <form action="/pengunjung/aspirasi/baru/Store" method="post" onsubmit="return submitFormRedirect(this, '/pengunjung/aspirasi')">
                @csrf
