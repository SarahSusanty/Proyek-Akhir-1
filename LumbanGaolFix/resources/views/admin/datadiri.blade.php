    ...
    <div class="content-right">
        <div class="bigContent flex-baru-row">
            <div class="biodata shadow-sm">
                <form action="/admin/biodata/save" method="post" onsubmit="return submitForm(this, false)">
            ...
            <div class="profile shadow-sm">
                <form action="/admin/biodata/profile/save" method="post" enctype="multipart/form-data" onsubmit="return submitForm(this, false)">
