    ...
    <div class="content-right">
        <div class="bigContent">
            ...
            <div class="formInformasi">
                <form action="/admin/informasi/New" method="post" enctype="multipart/form-data" onsubmit="return submitFormRedirect(this, '/admin/informasi')">
                    @csrf
                    <div class="form-group">
                        <label for="title">Judul Informasi</label>
                        <input type="text" name="title" id="" class="form-control" placeholder="Judul Informasi" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group mt-3">
                        ...
                        <textarea name="content" id="content" cols="30" rows="60" class="form-control"></textarea>
                    </div>
                    <button type="submit" class="col-12 btn btn-success">
                        <i class="fas fa-check"></i>Tambahkan Informasi</span>
        ...
        <div class="modal-dialog">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form action="/category/New" method="post" onsubmit="submitFormRedirect(this, '/admin/informasi/baru')">
                @csrf
                <div class="form-group">
